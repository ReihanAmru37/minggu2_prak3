...
Route::prefix('prodi')->group(function () {
    Route::get('/manajemen-informatika', function () {
        return "Program Studi Manajemen Informatika berdiri 24 Juni 2005. Berdasarkan SK Mendiknas 
            ...
            pendidikan Program Studi Manajemen Informatika untuk jenjang program Diploma (D3) Politeknik.
    ...
    Route::get('/teknik-informatika', function () {
        return "Pada tahun 2010 berdasar kebutuhan masyarakat dan industri terkait Program Diploma IV bidang 
            informatika maka Polinema mendirikan program studi baru Diploma IV (D4) Teknik Informatika (TI). 
            Pada awal berdirinya jumlah peserta didik Program D-IV TI hanya terdiri dari 46 Mahasiswa, namun pada 
            tahun 2015 jumlah peserta didik Prodi D4 TI telah mengalami peningkatan menjadi 545 Mahasiswa. Perkembangan 
            jumlah mahasiswa yang sangat pesat baik di Program Studi D3 MI maupun D4 TI mendorong pimpinan di Polinema 
            ...
            Informasi (JTI) dengan prodi D3 MI dan D4 TI
